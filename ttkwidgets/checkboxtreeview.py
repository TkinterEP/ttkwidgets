...
IM_CHECKED = os.path.join(get_assets_directory(), "photo", "checked.png")      # These three checkbox icons were isolated from
IM_UNCHECKED = os.path.join(get_assets_directory(), "photo", "unchecked.png")  # Checkbox States.svg (https://commons.wikimedia.org/wiki/File:Checkbox_States.svg?uselang=en)
IM_TRISTATE = os.path.join(get_assets_directory(), "photo", "tristate.png")    # by Marekich [CC BY-SA 3.0  (https://creativecommons.org/licenses/by-sa/3.0)]
